...
from .spectral_tools_main import SpectralToolsWindow
import os.path
...
class SpectralTools:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'SpectralTools_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Spectral Tools')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('SpectralTools', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/spectral_tools/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Inspector'),
            callback=self.run,
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.main_window = SpectralToolsWindow()
